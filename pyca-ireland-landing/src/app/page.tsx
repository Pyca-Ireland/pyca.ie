    ...
    <main className="bg-black min-h-screen">
      <div className="min-h-screen flex justify-center px-4">
        <div className="my-8 w-full max-w-xl flex flex-col border border-neutral-800">
          ...
          <div className="pb-4 flex flex-row justify-center gap-4">            
            <a
              href="https://tiktok.com/@pycaireland"
              target="_blank"
            ...
            <a
              href="https://github.com/Pyca-Ireland"
              target="_blank"
              rel="noopener noreferrer"
              className="w-8 h-8 rounded-full bg-white flex items-center justify-center hover:bg-neutral-200 transition-colors"
            >
            ...
            <a
              href="https://instagram.com/pycaireland"
              target="_blank"
              rel="noopener noreferrer"
              className="w-8 h-8 rounded-full bg-white flex items-center justify-center hover:bg-neutral-200 transition-colors"
            >
